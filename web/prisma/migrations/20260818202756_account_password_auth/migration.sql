...
CREATE TABLE "AuthToken" (
    ...
    CONSTRAINT "AuthToken_accountId_fkey" FOREIGN KEY ("accountId") REFERENCES "UserAccount" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
...
INSERT INTO "new_UserAccount" ("avatar", "claimId", "createdAt", "email", "googleSub", "id", "name", "playerId", "role") SELECT "avatar", "claimId", "createdAt", "email", "googleSub", "id", "name", "playerId", "role" FROM "UserAccount";
