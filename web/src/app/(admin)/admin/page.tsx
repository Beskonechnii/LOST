...
const TOOLS: HubTile[] = [
  ...
  { href: "/admin/registrations", label: "Регистрации", icon: "📝", desc: "Очередь новых заявок: анкета, одобрение с заведением профиля или возврат с причиной." },
  { href: "/admin/claims", label: "Заявки", icon: "🔗", desc: "Подтверждение привязки аккаунтов к профилям ростера." },
