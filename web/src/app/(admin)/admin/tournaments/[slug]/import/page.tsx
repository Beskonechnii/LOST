...
// (sheet-to-roster → import-roster), теперь делается отсюда и не пишет в ростер напрямую —
// разобранные команды попадают в очередь заявок (TOURNAMENTS-PLAN.md, этап 3).
  ...
  return (
    <main className="mx-auto w-full max-w-3xl flex-1 px-4 py-8 md:px-6">
      ...
      <p className="mt-1.5 text-sm text-ink-muted">
        ...
        блочную раскладку сезонной таблицы LOST. Ссылки берём и из текста ячейки, и из гиперссылки —
        из них же выводится account_id. Ничего не записывается, пока вы не нажмёте «Создать заявки».
      </p>
